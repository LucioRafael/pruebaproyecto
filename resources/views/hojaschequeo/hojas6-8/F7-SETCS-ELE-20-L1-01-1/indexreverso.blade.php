...
<html lang="en">
    ...
    <body id="vistas">
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoSETCS20112.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoSETCS20112/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoSETCS20112/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoSETCS20112')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>