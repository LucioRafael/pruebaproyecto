...
<form action="/F7-SETCS-ELE-60-L1-06-4-1-2"id="loginreg" method="POST">
    @csrf
    <div class="container">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="documentoid" id="documentoid" class="form-control" tabindex="1" hidden value="F7-SETCS-ELE-60-L1-06-4-1-2">
    </div>
    <div class="mb-3">
    ...
    <div>
        ...
        <a href="/F7-SETCS-ELE-60-L1-06-4-1-2" class="btn btn-danger">Cancelar</a>
    </div>
    </div>
</form>    
</body>
