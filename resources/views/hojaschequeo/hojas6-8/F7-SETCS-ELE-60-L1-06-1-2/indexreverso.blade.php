    ...
    <body id="vistas">
        ...
        <div>
            <nav class="navbar navbar-expand-lg bg-light">
                <div class="container-fluid">
                    ...
                    <div>
                    <a href="F7-SETCS-ELE-60-L1-06-1-2-2" class="btn btn-info" style="color: white">Volver</a>
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                @if ($reverso->documentoid == "F7-SETCS-ELE-60-L1-06-1-2-2" && $reverso->turno == "1")
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoSETCS606122.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoSETCS606122/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoSETCS606122/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoSETCS606122')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>