                ...
                <thead>
                    ...
                    <tbody>
                        @foreach ($registros as $registro)
                            @if ($registro->turno == '1' &&
                                $registro->documentoid == 'F7-SETCS-ELE-140-L1-01-3-1' &&
                    ...
                    <a href="{{route('checkSETCS140131')}}" class="btn btn-primary">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-SETCS-ELE-140-L1-01-3-1/create" class="btn btn-success">Añadir criterio</a>
                    <a href="{{route('pdfprintSETCS140131')}}" class="btn btn-danger">Guardar PDF</a>
                    @endrole
                    <a href="/reversoSETCS140131" class="btn btn-secondary">Reverso</a>                    
</body>
</html>