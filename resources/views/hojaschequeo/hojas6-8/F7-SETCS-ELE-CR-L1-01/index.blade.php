        ...
        <div class="table-responsive" align="center">
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <a href="{{route('checkT2')}}" class="btn btn-primary">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-SETCS-ELE-CR-L1-01-68/create" class="btn btn-success">Añadir criterio</a>
                    <a href="{{route('pdfprintT2')}}" class="btn btn-danger">Guardar PDF</a>
                    @endrole
                    <a href="/reversoT2" class="btn btn-secondary">Reverso</a>                    
</body>
</html>
