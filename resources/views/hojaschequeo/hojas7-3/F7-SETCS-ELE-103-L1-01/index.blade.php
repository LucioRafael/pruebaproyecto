        ...
        <div class="table-responsive" align="center">
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <a href="{{route('checkSETCS10313')}}" class="btn btn-primary">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-SETCS-ELE-103-L1-01-T3/create" class="btn btn-success">Añadir criterio</a>
                    <a href="{{route('pdfprintSETCS10313')}}" class="btn btn-danger">Guardar PDF</a>
                    @endrole
                    <a href="/reversoSETCS10313" class="btn btn-secondary">Reverso</a>                    
</body>
</html>
