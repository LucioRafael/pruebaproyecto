        ...
        <div class="table-responsive" align="center">
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <a href="{{route('checkTPM18011')}}" class="btn btn-primary">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-TPM-ELE-180-L1-01-1/create" class="btn btn-success">Añadir criterio</a>
                    <a href="{{route('pdfprintTPM18011')}}" class="btn btn-danger">Guardar PDF</a>
                    @endrole
                    <a href="/reversoTPM18011" class="btn btn-secondary">Reverso</a>                    
</body>
</html>
