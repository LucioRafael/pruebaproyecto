                ...
                @foreach ($datoshojas as $datoshoja)
                    @if ($datoshoja->documentoid == 'F7-SETCS-ELE-CR-L1-01' &&
                        ...
                        <tr>
                            ...
                            <th>
                            @role('Admin')
                            <a href="/edit2C2/{{$datoshoja->id}}" class="btn btn-warning">Editar</a>
                            @endrole                                
                            </th>
                            <th colspan="30"></th>
                        </tr>
        ...
        <div class="table-responsive" align="center">
            <table class="table table-success table-bordered">
                <thead>
                            ...
                            @if ($registro->turno == '1' &&
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="F7-SETCS-ELE-CR-L1-01-57/edit" class="btn btn-warning">Editar</a>
                                        @csrf
                                        @method('DELETE')
                    ...
                    <a href="{{route('checkC2')}}" class="btn btn-primary">Chequeo Diario</a>
                    @role('Admin')
                    <form action="{{ route('borrar-registros') }}" method="POST">
                        @csrf
                        <a href="F7-SETCS-ELE-CR-L1-01-57-2/create" class="btn btn-success">Añadir criterio</a>
                        <a href="{{route('pdfprintC2')}}" class="btn btn-danger">Guardar PDF</a>
                        <button type="submit" class="btn btn-danger">Borrar todos los registros</button>
                    </form>
                    
                    @endrole
                    <a href="/reversoC2" class="btn btn-secondary">Reverso</a>    
