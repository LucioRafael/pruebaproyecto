                ...
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                            @if ($registro->turno == '1' &&
                                $registro->documentoid == 'F7-SETCS-ELE-20-L1-01-1-3' &&
                    ...
                    <a href="{{route('checkSETCS201C3')}}" class="btn btn-primary">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-SETCS-ELE-20-L1-01-2-1C3/create" class="btn btn-success">Añadir criterio</a>
                    <a href="{{route('pdfprintSETCS201C3')}}" class="btn btn-danger">Guardar PDF</a>
                    @endrole
                    <a href="/reversoSETCS201C3" class="btn btn-secondary">Reverso</a>
</body>
</html>
