    ...
    <body id="vistas">
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                @if ($reverso->documentoid == "F7-SETCS-ELE-20-L1-01-1-4" && $reverso->turno == "1")
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoSETCS201C4.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoSETCS201C4/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoSETCS201C4/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoSETCS201C4')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>