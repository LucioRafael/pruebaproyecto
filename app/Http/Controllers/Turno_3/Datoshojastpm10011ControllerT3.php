...
class Datoshojastpm10011Controllert3 extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-100-L1-01.index')
    ...
    public function printindex()
    {
        $registros = Registro::all();
        $datoshojas = Datoshoja::all();
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-100-L1-01.printindex')
        ->with('registros',$registros)
        ->with('datoshojas',$datoshojas);
    }
    ...
    {
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-100-L1-01.create');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-100-L1-01.edit')->with('registro',$registro);
    }
    public function edit2($documentoid)
    {
        $datoshoja = Datoshoja::find($documentoid);
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-100-L1-01.edit2')->with('datoshoja',$datoshoja);
    }
    public function check(Request $request)
    {
        $registros = Registro::all();
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-100-L1-01.check')
        ->with('registros',$registros);
    }
    ...
    public function pdfprint()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas7-3.F7-TPM-ELE-100-L1-01.printindex');
        $pdf->setPaper('b3','landscape');
        return $pdf-> download('F7-TPM-ELE-100-L1-01-T3.pdf');
    }
}
