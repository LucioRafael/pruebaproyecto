...
use PDF;
class Reversotpm16011Controllert3 extends Controller
{
                               /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-160-L1-01.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-160-L1-01.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoTPM16013');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-160-L1-01.editreverso')->with('reverso',$reverso);
    }
    ...
    public function destroy($id)
    {
        $reverso = Reverso::find($id);
        $reverso->delete();
        return redirect('/reversoTPM160123');
    }
    public function pdfReverso()
    {
        $reversos = Reverso::all();
        view()-> share('reversos',$reversos);
        $pdf = PDF::loadView('hojaschequeo.hojas7-3.F7-TPM-ELE-160-L1-01.printreverso');
        $pdf->setPaper('b4','landscape');
        return $pdf-> download('Reverso-F7-TPM-ELE-160-L1-01-T3.pdf');
    }
}
